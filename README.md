...
The Dockerfile also contains useful information if you're planning on using a local setup, such as:
- Setting up an ONNX runtime library
- Downloading an embedding model and tokenizer
